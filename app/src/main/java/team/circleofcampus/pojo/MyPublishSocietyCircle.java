 ...
 * 本地数据库我发布的社团圈表映射对象
 */
@DatabaseTable(tableName = "t_my_publish_society_circle")
public class MyPublishSocietyCircle implements Serializable {
    /**
     * ID
     * 禁止自增长主键
     */
    ...
    public MyPublishSocietyCircle() {}

    public MyPublishSocietyCircle(int id, String title,
